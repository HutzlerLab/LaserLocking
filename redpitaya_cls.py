...
class RedPitaya:
    ...
    def __init__(self, rp_pyrpl, rp_scpi):
        self.pyrpl = rp_pyrpl #PyRPL interface to red pitaya
        self.scope = rp_pyrpl.scope #Scope interface
        self.scope.input1 = 'in1'
        self.scope.input2 = 'in2'
        self.asg1 = rp_pyrpl.asg0 #Arb Signal Gen for Out 1
        self.asg2 = rp_pyrpl.asg1 #Arb Signal Gen for Out 2
        self.asg1.output_direct = 'off'
        self.asg2.output_direct = 'off'
        self.pid_all = [rp_pyrpl.pid0,rp_pyrpl.pid1,rp_pyrpl.pid2,rp_pyrpl.pid3] #All 4 PID modules
        self.scpi = SCPI(rp_scpi) #SCPI command interface, useful for slow ADC
    ...
    def initializeRP(cls,ip):
    	pyrpl_interface = Pyrpl(config='global_config',hostname=ip)
        rp_pyrpl = pyrpl_interface.rp
        delimiter = '\r\n'
        port = 5000
